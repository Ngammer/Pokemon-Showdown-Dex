...
<html><head>
	...
	<link rel="stylesheet" href="//181.99.176.203:3000/style/font-awesome.css" />
	<link rel="stylesheet" href="/theme/panels.css?" />
	<link rel="stylesheet" href="/theme/main.css?" />
	<meta name="viewport" content="width=device-width,initial-scale=1">
	<link rel="stylesheet" href="//181.99.176.203:3000/style/utilichart.css?" />
	...
	<div class="pfx-topbar">
		<div class="header">
			...
			<ul class="nav nav-play">
				<li><a class="button greenbutton nav-first nav-last" href="http://181.99.176.203:3000/">Play</a></li>
			</ul>
...
<?php } ?>
	...
	<script src="//181.99.176.203:3000/config/config.js?"></script>
	<script src="//181.99.176.203:3000/js/battledata.js?"></script>
	<script src="//181.99.176.203:3000/data/search-index.js?"></script>
	<script src="//181.99.176.203:3000/data/pokedex.js?"></script>
	<script src="//181.99.176.203:3000/data/teambuilder-tables.js?"></script>
	<script src="//181.99.176.203:3000/data/learnsets.js?"></script>
	<script src="//181.99.176.203:3000/data/moves.js?"></script>
	<script src="//181.99.176.203:3000/data/abilities.js?"></script>
	<script src="//181.99.176.203:3000/data/items.js?"></script>
	<script src="//181.99.176.203:3000/data/formats-data.js?"></script>
	<script src="//181.99.176.203:3000/data/typechart.js?"></script>
	<script src="//181.99.176.203:3000/data/aliases.js?"></script>
	<script src="//181.99.176.203:3000/js/battle-dex-search.js?"></script>
	<script src="//181.99.176.203:3000/js/search.js?"></script>
